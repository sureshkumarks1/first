let table = new DataTable('#showproduct', {
    ...
    columns: [
        ...
        { data: 'image',
              ...
              return '<img src="'+data+'" width="100px" height="100px" alt="'+ data +'" id="zom" >';}
            },
        ...
        
        {
            ...
            orderable: false,
            render:(data)=>{return '<a href="http://localhost:3000/admin/products/prodedt/'+ data._id +'"><i class="fa fa-pencil"/></a>'}
        },
        {
            data: null,
...
function editrow(id){
    ...
    $.ajax({
        ...
        $.confirm({
            ...
            '<div class="form-group">' +
            '<label>Enter the Catagory</label>' +
            '<input type="text" placeholder="Your name" class="name form-control" name="newcat" value="'+response.name + '" required />' +
            '</div>' +
            '</form>',
            buttons: {
                formSubmit: {
